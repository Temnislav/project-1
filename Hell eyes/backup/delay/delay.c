 ...
 * - Запрос занятости автомата (находится он в режиме отсчёта таймера или нет)
...
/*Размер массива соответствующий кол-ву автоматов которые будут обращаться
к таймерам*/
/**----------------------------------------------------------------------------
 *
...
/**----------------------------------------------------------------------------
 *
 * \brief       Объявляем таймер htim_delay.
 *
 *-----------------------------------------------------------------------------
 */
...
static uint32_t delay_timer_mass[DELAY_TIMER_NUMBER];
...
{
  delay_timer_mass[name] = delay_time;
}
